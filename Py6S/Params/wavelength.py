    ...
    try:
        ...
        if end_wavelength is None:
            ...
            if start_wavelength > PredefinedWavelengths.MAX_ALLOWABLE_WAVELENGTH or start_wavelength < PredefinedWavelengths.MIN_ALLOWABLE_WAVELENGTH:
                raise sixs_exceptions.ParameterError("wavelength", "Wavelength must be between %f and %f" % (
                    PredefinedWavelengths.MIN_ALLOWABLE_WAVELENGTH, PredefinedWavelengths.MAX_ALLOWABLE_WAVELENGTH))
            wv_type = "-1"
            ...
            if filter is None:
                ...
                n_req_filter_values = round(
                    (end_wavelength - start_wavelength) / 0.0025) + 1
                if len(filter) != n_req_filter_values:
                    raise sixs_exceptions.ParameterError(
                        "wavelength", "You must provide a filter value at 2.5nm (0.0025um) intervals, including both the start and end wavelengths.")
...
#                                 0.002212,  0.001829,  0.001529,  0.001363,  0.001215]))
  ...
  # PROBAV_CAMERA_BAND
    ...
    # Himawari-8 AHI spectral response functions
    # Taken from https://www.data.jma.go.jp/mscweb/en/himawari89/space_segment/srf_201309/AHI-08_SpectralResponsivity.zip
    H8_AHI_01 = (801, 0.44, 0.5,
                 np.array(
                     [0.00046071, 0.00629904, 0.11277637, 0.31798469, 0.50122453, 0.66598842,
                      0.73007072, 0.78730078, 0.78390798, 0.83890026, 0.83536871, 0.92184646,
                      0.95498755, 0.95437943, 0.96512907, 0.96042249, 0.98783426, 0.98587353,
                      0.89850681, 0.72291152, 0.54995771, 0.30409723, 0.06743402, 0.01169797,
                      0.00205745]))

    H8_AHI_02 = (802, 0.48, 0.54,
                 np.array(
                     [0.00097806, 0.00361852, 0.01685611, 0.07925239, 0.20411124, 0.32813877,
                      0.49060672, 0.69648519, 0.92682972, 0.9849283, 0.99356279, 0.97506802,
                      0.9991787, 0.98314149, 0.99999819, 0.96452147, 0.85734773, 0.71265177,
                      0.55818848, 0.38594789, 0.18378267, 0.04120828, 0.01008257, 0.00277604,
                      0.00106666]))

    H8_AHI_03 = (803, 0.575, 0.700,
                 np.array(
                     [0.00043234, 0.00087154, 0.00199554, 0.0081511, 0.03240871, 0.06273807,
                      0.13830226, 0.21772231, 0.29818968, 0.41800105, 0.56037121, 0.73968146,
                      0.86949471, 0.89848745, 0.90532725, 0.93100289, 0.94708956, 0.93512354,
                      0.94564872, 0.97001258, 0.95537744, 0.93635298, 0.95888607, 0.97848647,
                      0.96240768, 0.9786986, 0.99861125, 0.98428506, 0.98417879, 0.99758088,
                      0.99905872, 0.99346522, 0.99159032, 0.99471562, 0.98682866, 0.98451339,
                      0.98824259, 0.96483789, 0.89444751, 0.81969854, 0.72332998, 0.62671913,
                      0.53127162, 0.39558489, 0.22144078, 0.09048085, 0.03417192, 0.01338478,
                      0.00570951, 0.00244248, 0.00101953]))

    H8_AHI_04 = (804, 0.82, 0.89,
                 np.array(
                     [0.00041726, 0.00200146, 0.00469756, 0.00869286, 0.02225074, 0.08168624,
                      0.21818939, 0.39009332, 0.5621686, 0.72237763, 0.85910706, 0.92758615,
                      0.91686426, 0.87474504, 0.87025373, 0.88587189, 0.92445927, 0.97582513,
                      0.99995755, 0.87504811, 0.72324731, 0.56298445, 0.41753501, 0.27207489,
                      0.13547977, 0.05555046, 0.02511792, 0.00818565, 0.0032477]))

    H8_AHI_05 = (805, 1.56, 1.66,
                 np.array(
                     [0.0021678, 0.003483, 0.0055148, 0.00942875, 0.01650775, 0.03033835,
                      0.05611306, 0.09818839, 0.15702901, 0.23623233, 0.32391714, 0.42314601,
                      0.5247561, 0.63418667, 0.74331083, 0.82826576, 0.86753121, 0.87362038,
                      0.85113074, 0.86790619, 0.91918324, 0.97980244, 0.99519212, 0.93466095,
                      0.86079154, 0.78590015, 0.69674881, 0.60611887, 0.51117028, 0.41207013,
                      0.3155976, 0.2310562, 0.15883821, 0.10453148, 0.06703336, 0.04223326,
                      0.02620264, 0.01627643, 0.01025549, 0.00666847, 0.00440402]))
